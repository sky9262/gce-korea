...
var isAndriod = navigator.userAgent.toLowerCase().indexOf("andriod") > -1;
if (isAndriod) {
  document.write(
    '<meta name="vuewport" content="width=device-width,heigth=' +
      window.innerHeight +
      ', initial-scale=1.0">'
  );
}
      ...
      <footer id="site-footer">
        ...
        <div className="container">
          <div className="social-icons">
            ...
            <a
              className="cursor2"
              href="https://gce-korea.github.io/"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="cursor2"
              href="mailto:githubcampusexperts.korea@gmail.com"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              className="cursor2"
              href="https://github.com/gce-korea"
              target="_blank"
              rel="noreferrer"
            >
          ...
          <span>Copyright © GitHub Campus Experts Korea 2021</span>

          <hr />
          <div className="PriTerm">
            <div className="Privacy cursor2">
              <a className="Privacy cursor2">Privacy Policy </a>
            </div>

            <i
              style={{ fontSize: "30px", display: "inline-block" }}
              className="fad fa-handshake"
            ></i>

            <div className="Terms cursor2">
              <a className="Terms cursor2"> Terms of Use</a>
            </div>
          </div>
        </div>
      </footer>
